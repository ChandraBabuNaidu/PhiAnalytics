...
public class MailSetup 
{
	...
	public MailSetup() throws Exception
	{
		try
		{
		FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"//src//poc//configuration//MailSetup.properties");
		...
		Zip.zipFolder(System.getProperty("user.dir")+"//src//reports//"+formattedDate,System.getProperty("user.dir")+"//Report - "+formattedDate+".zip");
