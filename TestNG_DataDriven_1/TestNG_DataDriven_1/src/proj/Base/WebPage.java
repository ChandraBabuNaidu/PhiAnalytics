...
public class WebPage
{
	...
	public static ArrayList<String> isElementVisible(Map<String,Pojo> Map1) throws Exception{
	...
	public static ArrayList<String> isAlltxtFieldsCleared(Map<String,Pojo> Map1) throws Exception{
	 ...
	 * @throws Exception
	 */
	public static ArrayList<String> isMessageValid(Map<String,Pojo> Map1) throws Exception{
		ArrayList<String> nondisplay = new ArrayList<String>();
		for (Map.Entry<String, Pojo> entry : Map1.entrySet()){
			Pojo obj = Map1.get(entry.getKey());
	...
	public static boolean isMessageValid(String Property, String PropertyType, String msg) throws Exception{
		if(WebPage.getText(Property,PropertyType).contentEquals(msg)){
	...
	public static boolean compareTwoStrings(String FirstString, String SecondString){
	boolean K=false;
	...
	public static boolean MatchListItems(WebElement WE, Map<String,String> value ) throws InterruptedException{
		try{
	...
	public static void fillElement(String elementlocator, String locatortype,String value){
		try{
